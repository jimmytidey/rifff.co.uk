...
<div id='edit'> 
    ...
    <div id="flash"> 
    	<object type="application/x-shockwave-flash"  data="flash/random_seed_composer.swf?debug=false&project_name=<? echo rawurlencode($_GET['project_name']) ?>&user_name=<? echo $_SESSION['user_name'] ?>"  width="960" height="2600">
    	</object>
    </div>
